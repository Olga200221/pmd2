    ...
    Column(
        ...
        Box(
            ...
            AndroidView(factory = {
                ...
                // Phong только для Луны, Нептун — без освещения (стандартный режим)
                val usePhong = isLuna
...
// Рендерер — расширен для поддержки Нептуна с водной текстурой
class PlanetRenderer(
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        // Выбор текстуры в зависимости от объекта
        val textureRes = when (index) {
            9 -> R.drawable.moon                // Луна — с Phong
            8 -> R.drawable.water       // Нептун — водная гладь, без Phong
            else -> R.drawable.earth            // запасной
        }
