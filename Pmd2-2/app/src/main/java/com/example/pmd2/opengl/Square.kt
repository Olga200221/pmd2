...
class Square(private val textureId: Int) {
    ...
    init {
        ...
        Matrix.scaleM(modelMatrix, 0, 5f, 5f, 1f)  // растягиваем квадрат под фон
        Matrix.translateM(modelMatrix, 0, 0f, 0f, -5f) // отодвигаем назад
    }
    ...
    fun draw(vpMatrix: FloatArray) {
        ...
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, indices.size, GLES20.GL_UNSIGNED_SHORT, TextureHelper.createIndexBuffer(indices))
